...
(ROUTE_ID INT NOT NULL, UNIQUE (ROUTE_ID),
 ...
 ORIGIN_AIRPORT TEXT VARCHAR(3) NOT NULL, 
 DESTINATION_AIRPORT TEXT VARCHAR(100) NOT NULL, 
...
--  Query 4 : IDENTIFY THE NUMBER OF PASSENGERS AND TOTAL REVENUE IN BUISNESS CLASS FROM THE TICKET DETAILS TABLE.
SELECT COUNT(CUSTOMER_ID) AS 'NO. OF PASSENGER' , SUM(PRICE_PER_TICKET) AS REVENUE FROM TICKET_DETAILS WHERE CLASS_ID='BUISNESS' ;


--  QUERY 5 : TOTAL NUMBER OF PASSENGERS AND TOTAL REVENUE FROM BUSINESS CLASS -
...
-- Query 6 :  DISPLAY THE FULL NAME OF THE CUSTOMER BY EXTRACTING THE FIRST NAME AND LAST NAME FROM THE CUSTOMER TABLE.
SELECT  CUSTOMER_ID, CONCAT(FIRST_NAME,LAST_NAME) AS  "FULL NAME"  , DATE_OF_BIRTH,GENDER from CUSTOMER;


-- QUERY 7 : GENERATING FULL NAME OF THE CUSTOMER -
SELECT UCASE(CONCAT(FIRST_NAME , ' ' , LAST_NAME)) AS FULL_NAME 
FROM CUSTOMER_DETAILS ;

-- QUERY 8 : EXTRACT THE CUSTOMERS WHO HAVE REGISTERED AND BOOKED A TICKET.
...
-- QUERY 8 : CUSTOMER DETAILS WHO HAVE BOOKED A TICKET -
...
-- QUERY 9 : CUSTOMER DETAILS BASED ON CUSTOMER_ID AND BRAND(EMIRATES) -
...
-- QUERY 10 : CUSTOMERS WHO HAVE TRAVELLED IN ECONOMY CLASS -
SELECT * FROM PASSENGERS_ON_FLIGHTS 
GROUP BY SEAT_NUM
HAVING CLASS_ID = 'ECONOMY'
ORDER BY CUSTOMER_ID ;

-- QUERY 11 : DISPLAY IF TOTAL REVENUE CROSSED 10000 -
SELECT IF(SUM(PRICE_PER_TICKET) >10000 , "YES", "NO") AS 'DID REVENUE CROSSED 10000?'
FROM TICKET_DETAILS;

-- QUERY 12 : TO IDENTIFY THE CUSTOMERS WHO HAVE TRAVELED BY ECONOMY PLUS CLASS USING GROUP BY AND HAVING CLAUSE
...
-- QUERY 14 : TO IDENTIFY WHETHER THE REVENUE HAS CROSSED 10000 USING THE IF CLAUSE ON THE TICKET_DETAILS TABLE
...
-- QUERY 22 : CREATING A CURSOR TO GET THE FIRST RECORD OF CUSTOMER HAVING LAST NAME 'SCOTT' -
